#!/usr/bin/env python
"""
Package metadata for x_courses.
"""
import os
import re
import sys
...
VERSION = get_version('x_courses', '__init__.py')
...
setup(
    name='x_courses',
    version=VERSION,
    description="""list of x_courses""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/x_courses',
    packages=find_packages(
        include=['x_courses', 'x_courses.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "x_courses = x_courses.apps:CoursesCatalogConfig",
        ],
    },
)
